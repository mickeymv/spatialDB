...
void Point2DRegion2D::exploreTopoPred() {
    ...
    while ((S.getStatus() == ParallelObjectTraversal::end_of_none) && (!(vF[poi_inside])) && (vF[poi_on_bound]) &&
           (vF[poi_outside])) {
        ...
        else {   //object not equal to first
...
bool Point2DRegion2D::overlap() {
    ...
    if (topPredNumberPoint2DRegion2D == TopPredNumberPoint2DRegion2D::pr_overlap_m5 ||
        topPredNumberPoint2DRegion2D == TopPredNumberPoint2DRegion2D::pr_overlap_m7) {
        return true;
    }
    return false;
...
bool Point2DRegion2D::meet() {
    ...
    if (topPredNumberPoint2DRegion2D == TopPredNumberPoint2DRegion2D::pr_meet_m2 ||
        topPredNumberPoint2DRegion2D == TopPredNumberPoint2DRegion2D::pr_meet_m3) {
        return true;
    }
...
bool Point2DRegion2D::inside() {
    ...
    if (topPredNumberPoint2DRegion2D == TopPredNumberPoint2DRegion2D::pr_inside_m4 ||
        topPredNumberPoint2DRegion2D == TopPredNumberPoint2DRegion2D::pr_inside_m6) {
        return true;
    }
    return false;
