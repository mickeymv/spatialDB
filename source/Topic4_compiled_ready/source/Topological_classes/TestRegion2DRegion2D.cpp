...
void TestRegion2DRegion2D::start() {
    ...
    printPredicate(trrred);

    result = isTopologicalRelationship(*arr, *brr, TopPredNumberRegion2DRegion2D::rr_equal_m5);
    cout << "   isTopologicalRelationship(a, b, rr_equal_m5) ==> " << printBool(result) << endl;

    cout << "   equal() ==> " << printBool(equal(*arr, *brr)) << endl;
    cout << "   overlap() ==> " << printBool(overlap(*arr, *brr)) << endl;
    cout << endl;
    ...
    cout << "   isTopologicalRelationship(a, b, rr_disjoint_m1) ==> " << printBool(result) << endl;
    cout << "   returns ==> " << result << endl;
    cout << "   disjoint() ==> " << printBool(disjoint(*arr, *brr)) << endl;
    cout << "   overlap() ==> " << printBool(overlap(*arr, *brr)) << endl;
    cout << endl;
    ...
    cout << "   isTopologicalRelationship(a, b, rr_meet_m4) ==> " << printBool(result) << endl;

    cout << "   meet() ==> " << printBool(touch(*arr, *brr)) << endl;
    cout << "   overlap() ==> " << printBool(overlap(*arr, *brr)) << endl;
    cout << endl;
    ...
    cout << "   isTopologicalRelationship(a, b, rr_inside_m7) ==> " << printBool(result) << endl;

    cout << "   inside() ==> " << printBool(inside(*arr, *brr)) << endl;
    cout << "   overlap() ==> " << printBool(overlap(*arr, *brr)) << endl;
    cout << endl;
    ...
    cout << "   isTopologicalRelationship(a, b, rr_contains_m19) ==> " << printBool(result) << endl;

    cout << "   contains() ==> " << printBool(contains(*arr, *brr)) << endl;
    cout << "   overlap() ==> " << printBool(overlap(*arr, *brr)) << endl;
    cout << endl;
    ...
    cout << "   isTopologicalRelationship(a, b, rr_overlap_m14)  ==> " << printBool(result) << endl;
    ...
    cout << "   isTopologicalRelationship(a, b, rr_coveredby_m6) ==> " << printBool(result) << endl;

    cout << "   covers() ==> " << printBool(coveredBy(*arr, *brr)) << endl;
    cout << "   contains() ==> " << printBool(contains(*arr, *brr)) << endl;
    cout << endl;
    ...
    cout << "   isTopologicalRelationship(a, b, rr_covers_m11) ==> " << printBool(result) << endl;

    cout << "   covers() ==> " << printBool(covers(*arr, *brr)) << endl;
    cout << "   contains() ==> " << printBool(contains(*arr, *brr)) << endl;
    cout << endl;
