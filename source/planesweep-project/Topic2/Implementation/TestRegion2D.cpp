...
////
////    Region2D regionA("(((4,3),(6,4)),((4,3),(6,2)),((6,2),(6,4)))"), regionB("(((0,0),(1,1)),((0,0),(0,2)),((0,2),(1,1)))");
////
////    Region2DImpl* regionAImpl= static_cast<Region2DImpl*> (&regionA);
////    Region2DImpl* regionBImpl= static_cast<Region2DImpl*> (&regionB);
//
////    //Case3
...
//
//    Region2DImpl regionAImpl(segmentsVector1), regionBImpl(segmentsVector2);
//    Region2DImpl::ConstAttributedHalfSegmentIterator At1, At2, At3 ;
//    //At1 = regionAImpl->cbegin();
//
//    cout<< "Result of cbegin of attributed half segment iterator for Region Implementation 1 \n" << At1 << endl;
//
...
//    //Case10-8
//    cout<<"\n------------------ITERATING!!!!!!-----------------"<<endl;
//    for ( Region2DImpl::ConstAttributedHalfSegmentIterator At1 = regionBImpl.cbegin(); At1 < regionBImpl.ctail(); ++At1 )
