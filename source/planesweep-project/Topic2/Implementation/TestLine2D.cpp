...
int main() 
{
    ...
    //iterator loop through the Line8Impl structure
    ...
    cout << "\n \n output for half segment iterating....better example to understand sorting: \n ";
    //iterator loop through the Line8Impl structure
    for ( Line2DImpl::ConstHalfSegIterator l3HSegItr = Line81Impl.hBegin(); l3HSegItr < Line81Impl.hTail(); ++l3HSegItr )
        cout << " output: " << l3HSegItr << endl;     
