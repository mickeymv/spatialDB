...
//
//    //Region2D regionA("(((4,3),(6,4)),((4,3),(6,2)),((6,2),(6,4)))"), regionB("(((0,0),(1,1)),((0,0),(0,2)),((0,2),(1,1)))"), regionC, regionCD, regionEF, regionF, regionGH, regionHI;
//
//    /*
...
////    cout<<"regionUnion12 info is: " << regUnionNull;
////
...
////    cout<<"regionDifference12 info is: " << regDiffNull;
////    if(regDiffNull.isEmptyRegion2D())
////        cout<<"empty regionDifference12 structure"<<endl;
////    else
////        cout<<"nonempty regionDifference12 structure"<<endl;
////    cout<<"regionDifference12 number of segments is " <<regDiffNull.getNumberOfSegments()<<endl;
////    cout<<endl;
//
//
////    //Case 1.Iy
...
////    cout<<"regionDifference12 info is: " << regDiffA;
////    if(regDiffA.isEmptyRegion2D())
////        cout<<"empty regionDifference12 structure"<<endl;
////    else
////        cout<<"nonempty regionDifference12 structure"<<endl;
////    cout<<"regionDifference12 number of segments is " <<regDiffA.getNumberOfSegments()<<endl;
////    cout<<endl;
////
////    //Case 1.Iz
////    cout<<"---------------------------------------" << endl;
